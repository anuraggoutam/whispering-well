...
!(function (e, t) {
  ...
  !(function (t, r, n) {
    function i(e) {
      var n = r[e];
      return (
        n || t[e][0].call((n = r[e] = { exports: {} }), i, n, n.exports),
        n.exports
      );
    }
    var o = (e.protobuf = i(n[0]));
    'function' == typeof define &&
      define.amd &&
      define(['long'], function (e) {
        return e && e.isLong && ((o.util.Long = e), o.configure()), o;
      }),
  ...
  })(
    {
      1: [
        function (e, t) {
          function r(e, t) {
            for (
              var r = Array(arguments.length - 1), n = 0, i = 2, o = !0;
              i < arguments.length;
        ...
        function (e, r, n) {
          ...
          i.encode = function (e, t, r) {
            for (var n, i = null, s = [], a = 0, u = 0; t < r; ) {
              ...
              switch (u) {
                case 0:
                  (s[a++] = o[f >> 2]), (n = (3 & f) << 4), (u = 1);
                  break;
                case 1:
                  (s[a++] = o[n | (f >> 4)]), (n = (15 & f) << 2), (u = 2);
                  break;
                case 2:
                  (s[a++] = o[n | (f >> 6)]), (s[a++] = o[63 & f]), (u = 0);
              }
              a > 8191 &&
            ...
            return (
              ...
              i
                ? (a &&
                    i.push(String.fromCharCode.apply(String, s.slice(0, a))),
                  i.join(''))
                : String.fromCharCode.apply(String, s.slice(0, a))
            );
          };
          (i.decode = function (e, r, n) {
            for (var i, o = n, a = 0, u = 0; u < e.length; ) {
              var f = e.charCodeAt(u++);
              if (61 === f && a > 1) break;
              if ((f = s[f]) === t) throw Error('invalid encoding');
              switch (a) {
                case 0:
                  (i = f), (a = 1);
                  break;
                case 1:
                  (r[n++] = (i << 2) | ((48 & f) >> 4)), (i = f), (a = 2);
                  break;
                case 2:
                  (r[n++] = ((15 & i) << 4) | ((60 & f) >> 2)),
                    (i = f),
              ...
              if ('string' != typeof e) {
                ...
                if (
                  ...
                  for (
                    ...
                    (a[f] = r[f]), (u[f] = e[r[f++]]);
                  return (a[f] = t), Function.apply(null, a).apply(null, u);
                }
                return Function(t)();
              }
              for (var l = Array(arguments.length - 1), c = 0; c < l.length; )
                l[c] = arguments[++c];
              if (
                ((c = 0),
        ...
        function (e, r) {
          ...
          (r.exports = n),
            (n.prototype.on = function (e, t, r) {
              return (
                (this.a[e] || (this.a[e] = [])).push({ fn: t, ctx: r || this }),
                this
              );
            }),
            (n.prototype.off = function (e, r) {
              if (e === t) this.a = {};
              else if (r === t) this.a[e] = [];
              else
                for (var n = this.a[e], i = 0; i < n.length; )
      ...
      5: [
        function (e, r) {
          ...
          var i = e(1),
            o = e(7),
            s = o('fs');
          n.xhr = function (e, r, n) {
            var i = new XMLHttpRequest();
            (i.onreadystatechange = function () {
              if (4 !== i.readyState) return t;
              ...
              'undefined' != typeof Float64Array
                ? (function () {
                    ...
                    (e.writeDoubleLE = a ? t : r),
                      ...
                      (e.readDoubleLE = a ? n : i),
                      (e.readDoubleBE = a ? i : n);
                  })()
                : (function () {
                    ...
                    function r(e, t, r, n, i) {
                      ...
                      return 2047 === u
                        ...
                        : 0 === u
                        ? 5e-324 * a * f
                        : a * Math.pow(2, u - 1075) * (f + 4503599627370496);
                    }
      ...
      11: [
        function (e, t) {
          ...
          r('duration', {
            ...
            r('timestamp', { Timestamp: i }),
            r('empty', { Empty: { fields: {} } }),
            r('struct', {
              Struct: {
          ...
          function n(e, t, r, n) {
            if (t.resolvedType)
              if (t.resolvedType instanceof s) {
                e('switch(d%s){', n);
                for (
                  var i = t.resolvedType.values, o = Object.keys(i), a = 0;
                  a < o.length;
                  ++a
                )
                  t.repeated && i[o[a]] === t.typeDefault && e('default:'),
                    e('case%j:', o[a])('case %i:', i[o[a]])(
                      'm%s=%j',
                      n,
                      i[o[a]]
                    )('break');
          ...
          (o.fromObject = function (e) {
            ...
            (o.toObject = function (e) {
              ...
              for (
                ...
                t[u].partOf ||
                  (t[u].resolve().repeated ? n : t[u].map ? o : s).push(t[u]);
              var f,
                l,
                c = !1;
          ...
          function i(e) {
            ...
            for (var i = 0; i < e.fieldsArray.length; ++i) {
              var u = e.b[i].resolve(),
                ...
                l = 'm' + a.safeProp(u.name);
              r('case %i:', u.id),
                u.map
                  ? (r('r.skip().pos++')('if(%s===util.emptyObject)', l)(
                      '%s={}',
                      l
                    )(
                      'k=r.%s()',
                    ...
                    s.long[u.keyType] !== t
                      ...
                      : s.basic[f] === t
                      ? r('%s[k]=types[%i].decode(r,r.uint32())', l, i)
                      : r('%s[k]=r.%s()', l, f))
                  : u.repeated
                  ? (r('if(!(%s&&%s.length))', l, l)('%s=[]', l),
                    s.packed[f] !== t &&
            ...
            for (
              r('default:')('r.skipType(t&7)')('break')('}')('}'), i = 0;
              i < e.b.length;
              ++i
            ) {
              var c = e.b[i];
              c.required &&
                r('if(!m.hasOwnProperty(%j))', c.name)(
        ...
        function (e, r) {
          ...
          function i(e) {
            for (
              var r,
                i,
                u = a.codegen(['m', 'w'], e.name + '$encode')('if(!w)')(
                  'w=Writer.create()'
                ),
              ...
              var l = f[r].resolve(),
                c = e.b.indexOf(l),
                p = l.resolvedType instanceof o ? 'int32' : l.type,
                h = s.basic[p];
              (i = 'm' + a.safeProp(l.name)),
                l.map
                  ? (u(
                    ...
                    h === t
                      ...
                      : u('.uint32(%i).%s(%s[ks[i]]).ldelim()', 16 | h, p, i),
                    u('}')('}'))
                  : l.repeated
                  ? (u('if(%s!=null&&%s.length){', i, i),
                    l.packed && s.packed[p] !== t
                      ? u('w.uint32(%i).fork()', ((l.id << 3) | 2) >>> 0)(
                    ...
                    u('}'))
                  : (l.optional &&
                      u('if(%s!=null&&m.hasOwnProperty(%j))', i, l.name),
                    h === t
                      ? n(u, l, c, i)
                      : u(
                          'w.uint32(%i).%s(%s)',
      ...
      15: [
        function (e, r) {
          function n(e, r, n, o, s) {
            ...
            if (
              ...
              for (var a = Object.keys(r), u = 0; u < a.length; ++u)
                'number' == typeof r[a[u]] &&
                  (this.valuesById[(this.values[a[u]] = r[a[u]])] = a[u]);
          }
          r.exports = n;
          var i = e(24);
          ...
          (n.fromJSON = function (e, t) {
            var r = new n(e, t.values, t.options, t.comment, t.comments);
            ...
            (n.prototype.toJSON = function (e) {
              ...
              return s.toObject([
                ...
                this.values,
                'reserved',
                this.reserved && this.reserved.length ? this.reserved : t,
                'comment',
                r ? this.comment : t,
                'comments',
                r ? this.comments : t,
            ...
            (n.prototype.add = function (e, r, n) {
      ...
      16: [
        function (e, r) {
          function n(e, r, n, o, s, l, c) {
            if (
              (u.isObject(o)
                ? ((c = s), (l = o), (o = s = t))
                : u.isObject(s) && ((c = l), (l = s), (s = t)),
              i.call(this, e, l),
              !u.isInteger(r) || r < 0)
            )
              throw TypeError('id must be a non-negative integer');
            if (!u.isString(n)) throw TypeError('type must be a string');
            if (o !== t && !f.test((o = ('' + o).toLowerCase())))
          ...
          (n.fromJSON = function (e, t) {
            ...
            Object.defineProperty(n.prototype, 'packed', {
              get: function () {
                return (
                  null === this.c && (this.c = !1 !== this.getOption('packed')),
                  this.c
                );
              },
            }),
            ...
            (n.prototype.toJSON = function (e) {
              ...
              return u.toObject([
                'rule',
                ('optional' !== this.rule && this.rule) || t,
                'type',
                this.type,
                'id',
                this.id,
            ...
            (n.prototype.resolve = function () {
              ...
              if (
                ((this.typeDefault = a.defaults[this.type]) === t &&
                  ((this.resolvedType = (
                    this.declaringField
                ...
                this.options &&
                  ((!0 !== this.options.packed &&
                    (this.options.packed === t ||
                      !this.resolvedType ||
                      this.resolvedType instanceof s)) ||
                    delete this.options.packed,
                  Object.keys(this.options).length || (this.options = t)),
                this.long)
              )
      ...
      17: [
        function (e, t) {
          ...
          (i.build = 'light'),
            ...
            (i.types = e(36)),
            (i.util = e(37)),
            i.ReflectionObject.e(i.Root),
            i.Namespace.e(i.Type, i.Service),
            i.Root.e(i.Type),
            i.Field.e(i.Type);
        },
        {
      ...
      19: [
        function (e, t) {
          ...
          (r.build = 'full'),
            ...
            (r.parse = e(26)),
            (r.common = e(11)),
            r.Root.e(r.Type, r.parse, r.common);
        },
        { 11: 11, 17: 17, 26: 26, 34: 34 },
      ],
      20: [
        function (e, r) {
          function n(e, r, n, o, a, u) {
            if ((i.call(this, e, r, o, t, t, a, u), !s.isString(n)))
          ...
          (n.fromJSON = function (e, t) {
            ...
            (n.d = function (e, t, r) {
              return (
                ...
                function (i, o) {
                  s.decorateType(i.constructor).add(new n(o, e, t, r));
                }
              );
            });
        },
      ...
      22: [
        function (e, r) {
          function n(e, r, n, s, a, u, f, l) {
            if (
              (o.isObject(a)
                ? ((f = a), (a = u = t))
                : o.isObject(u) && ((f = u), (u = t)),
              r !== t && !o.isString(r))
            )
      ...
      23: [
        function (e, r) {
          ...
          function i(e, r) {
            s.call(this, e, r), (this.nested = t), (this.f = null);
          }
          function o(e) {
            return (e.f = null), e;
          }
          ...
          (i.fromJSON = function (e, t) {
            ...
            Object.defineProperty(i.prototype, 'nestedArray', {
              get: function () {
                return this.f || (this.f = c.toArray(this.nested));
              },
            }),
            (i.prototype.toJSON = function (e) {
              return c.toObject([
                ...
                this.options,
                'nested',
                n(this.nestedArray, e),
              ]);
            }),
            (i.prototype.addJSON = function (e) {
              var r = this;
              if (e)
                for (var n, o = Object.keys(e), s = 0; s < o.length; ++s)
                  (n = e[o[s]]),
                    r.add(
                      (n.fields !== t
                        ? a.fromJSON
            ...
            (i.prototype.add = function (e) {
              ...
              if (this.nested) {
                ...
                if (r) {
                  if (
                    !(r instanceof i && e instanceof i) ||
                    r instanceof a ||
                    r instanceof u
                  )
                    throw Error("duplicate name '" + e.name + "' in " + this);
                  for (var n = r.nestedArray, s = 0; s < n.length; ++s)
                    e.add(n[s]);
                  this.remove(r),
            ...
            (i.prototype.lookup = function (e, r, n) {
              if (
                ('boolean' == typeof r
                  ? ((n = r), (r = t))
              ...
              if (o) {
                ...
                } else if (o instanceof i && (o = o.lookup(e.slice(1), r, !0)))
                  return o;
              } else
                for (var s = 0; s < this.nestedArray.length; ++s)
                  if (
                    this.f[s] instanceof i &&
                    (o = this.f[s].lookup(e, r, !0))
                  )
                    return o;
              return null === this.parent || n
                ? null
                : this.parent.lookup(e, r);
            }),
      ...
      24: [
        function (e, r) {
          ...
          (r.exports = n), (n.className = 'ReflectionObject');
          var i,
            o = e(37);
          Object.defineProperties(n.prototype, {
            ...
            (n.prototype.setOption = function (e, r, n) {
              return (
                (n && this.options && this.options[e] !== t) ||
      ...
      25: [
        function (e, r) {
          function n(e, r, n, i) {
            if (
              (Array.isArray(r) || ((n = r), (r = t)),
              o.call(this, e, n),
              r !== t && !Array.isArray(r))
            )
              throw TypeError('fieldNames must be an Array');
            (this.oneof = r || []), (this.fieldsArray = []), (this.comment = i);
          }
          function i(e) {
            if (e.parent)
          ...
          var s = e(16),
            a = e(37);
          (n.fromJSON = function (e, t) {
            return new n(e, t.oneof, t.options, t.comment);
          }),
            (n.prototype.toJSON = function (e) {
              var r = !!e && !!e.keepComments;
              return a.toObject([
            ...
            (n.d = function () {
              for (
                ...
                e[t] = arguments[t++];
              return function (t, r) {
                a.decorateType(t.constructor).add(new n(r, e)),
        ...
        function (e, r) {
          function n(e, r, A) {
            ...
            function R(e, t) {
              ...
              if (y.test(e)) return r * parseInt(e, 10);
              if (v.test(e)) return r * parseInt(e, 16);
              if (b.test(e)) return r * parseInt(e, 8);
              if (O.test(e)) return r * parseFloat(e);
              throw S(e, 'number', t);
            }
            function I(e, t) {
              switch (e) {
            ...
            function L(e, t, r) {
              var i = Y.line;
              if (
                (e && ((e.comment = ie()), (e.filename = n.filename)),
                ne('{', !0))
              ) {
                for (var o; '}' !== (o = ee()); ) t(o);
                ne(';', !0);
                ...
                r && r(),
                  ne(';'),
                  e && 'string' != typeof e.comment && (e.comment = ie(i));
            }
            function B(e, t) {
              if (!k.test((t = ee()))) throw S(t, 'type name');
              var r = new s(t);
              L(r, function (e) {
                if (!F(r, e))
                  switch (e) {
                    ...
                    case 'oneof':
                      ...
                      break;
                    case 'extensions':
                      N(r.extensions || (r.extensions = []));
                      break;
                    case 'reserved':
                      N(r.reserved || (r.reserved = []), !0);
                      break;
                    default:
                      if (!se || !j.test(e)) throw S(e);
                      te(e), J(r, 'optional');
                  }
              }),
                e.add(r);
            ...
            function J(e, r, n) {
              var i = ee();
              if ('group' === i) return void $(e, r);
              if (!j.test(i)) throw S(i, 'type');
              var o = ee();
              if (!k.test(o)) throw S(o, 'name');
              (o = ue(o)), ne('=');
              var s = new a(o, I(ee()), i, r, n);
              L(
                s,
                function (e) {
                ...
                se ||
                  !s.repeated ||
                  (h.packed[i] === t && h.basic[i] !== t) ||
                  s.setOption('packed', !1, !0);
            }
            function $(e, t) {
              var r = ee();
              if (!k.test(r)) throw S(r, 'name');
              var i = d.lcFirst(r);
              r === i && (r = d.ucFirst(r)), ne('=');
              var o = I(ee()),
                u = new s(r);
              u.group = !0;
              var f = new a(i, o, r, t);
            ...
            function D(e) {
              ne('<');
              var r = ee();
              if (h.mapKey[r] === t) throw S(r, 'type');
              ne(',');
              var n = ee();
              if (!j.test(n)) throw S(n, 'type');
              ne('>');
              var i = ee();
              if (!k.test(i)) throw S(i, 'name');
              ne('=');
              var o = new u(ue(i), I(ee()), r, n);
              L(
                o,
                function (e) {
                  if ('option' !== e) throw S(e);
            ...
            function P(e, t) {
              if (!k.test((t = ee()))) throw S(t, 'name');
              var r = new f(ue(t));
              L(r, function (e) {
                'option' === e ? (V(r, e), ne(';')) : (te(e), J(r, 'optional'));
              }),
                e.add(r);
            }
            function C(e, t) {
            ...
            function _(e, t) {
              if (!k.test((t = ee()))) throw S(t, 'service name');
              var r = new c(t);
              L(r, function (e) {
                if (!F(r, e)) {
                  if ('rpc' !== e) throw S(e);
            ...
            function H(e, t) {
              ...
              var n,
                ...
                s,
                a = t;
              if ((ne('('), ne('stream', !0) && (i = !0), !j.test((t = ee()))))
                throw S(t);
              if (
                ((n = t),
                ne(')'),
            ...
            function Z(e, t) {
              if (!j.test((t = ee()))) throw S(t, 'reference');
              var r = t;
              L(null, function (t) {
                switch (t) {
                  case 'required':
                  ...
                  case 'optional':
                    ...
                    break;
                  default:
                    if (!se || !j.test(t)) throw S(t);
                    te(t), J(e, 'optional', r);
                }
              });
            }
            r instanceof o || ((A = r), (r = new o())), A || (A = n.defaults);
            for (
              var W,
                K,
                G,
                X,
                Q,
                Y = i(e, A.alternateCommentMode || !1),
                ee = Y.next,
                te = Y.push,
                re = Y.peek,
                ne = Y.skip,
              ...
              switch (Q) {
                case 'package':
                  if (!oe) throw S(Q);
                  !(function () {
                    if (W !== t) throw S('package');
                    if (((W = ee()), !j.test(W))) throw S(W, 'name');
                    (ae = ae.define(W)), ne(';');
                  })();
                  break;
                case 'import':
            ...
            return (
              (n.filename = null),
              { package: W, imports: K, weakImports: G, syntax: X, root: r }
            );
          }
          (r.exports = n), (n.filename = null), (n.defaults = { keepCase: !1 });
          var i = e(34),
            o = e(29),
            s = e(35),
            a = e(16),
          ...
          (n.create = u.Buffer
            ? function (e) {
                return (n.create = function (e) {
                  return u.Buffer.isBuffer(e) ? new a(e) : c(e);
                })(e);
              }
            : c),
            (n.prototype.i =
            ...
            (n.e = function (e) {
              ...
              u.merge(n.prototype, {
                ...
                sint64: function () {
                  return i.call(this).zzDecode()[t](!1);
                },
                fixed64: function () {
      ...
      28: [
        function (e, t) {
          ...
          var i = e(39);
          i.Buffer && (r.prototype.i = i.Buffer.prototype.slice),
      ...
      29: [
        function (e, r) {
          ...
          function o(e, r) {
            ...
            if (n) {
              var i = new l(r.fullName, r.id, r.type, r.rule, t, r.options);
              return (
          ...
          (n.fromJSON = function (e, t) {
            ...
            (n.prototype.load = function e(r, n, o) {
              function s(e, t) {
                if (o) {
                  var r = o;
                  if (((o = null), p)) throw e;
                ...
                try {
                  if (
                    ...
                    var r,
                      ...
                      o = 0;
                    if (i.imports)
                      for (; o < i.imports.length; ++o)
                        (r = c.resolvePath(e, i.imports[o])) && l(r);
                    if (i.weakImports)
                      for (o = 0; o < i.weakImports.length; ++o)
                        (r = c.resolvePath(e, i.weakImports[o])) && l(r, !0);
              ...
              function l(e, t) {
                ...
                if (!(c.files.indexOf(e) > -1)) {
                  if ((c.files.push(e), e in f))
                    return void (p
                      ? a(e, f[e])
                      : (++d,
                        setTimeout(function () {
                  ...
                  if (p) {
                    ...
                    ++d,
                      h.fetch(e, function (r, n) {
                        if ((--d, o))
                          return r
                            ? void (t ? d || s(null, c) : s(r))
                            : void a(e, n);
                      });
                }
              }
              'function' == typeof n && ((o = n), (n = t));
              var c = this;
              if (!o) return h.asPromise(e, c, r, n);
              var p = o === i,
                d = 0;
              h.isString(r) && (r = [r]);
              for (var y, m = 0; m < r.length; ++m)
                (y = c.resolvePath('', r[m])) && l(y);
              return p ? c : (d || s(null, c), t);
            }),
          ...
          (n.prototype.g = function (e) {
            if (e instanceof l)
              ...
              for (var n = 0; n < e.nestedArray.length; ++n) this.g(e.f[n]);
            ...
            (n.prototype.h = function (e) {
              if (e instanceof l) {
                ...
                for (var n = 0; n < e.nestedArray.length; ++n) this.h(e.f[n]);
                d.test(e.name) && delete e.parent[e.name];
              }
            }),
            (n.e = function (e, t, r) {
      ...
      32: [
        function (e, r) {
          ...
          ((n.prototype = Object.create(i.EventEmitter.prototype)).constructor =
            n),
            (n.prototype.rpcCall = function e(r, n, o, s, a) {
              if (!s) throw TypeError('request must be specified');
              var u = this;
              if (!a) return i.asPromise(e, u, r, n, o, s);
              if (!u.rpcImpl)
                return (
                  setTimeout(function () {
              ...
              try {
                return u.rpcImpl(
                  ...
                  function (e, n) {
                    if (e) return u.emit('error', e, r), a(e);
                    if (null === n) return u.end(!0), t;
                    if (!(n instanceof o))
                      try {
                        n =
      ...
      33: [
        function (e, r) {
          function n(e, t) {
            o.call(this, e, t), (this.methods = {}), (this.j = null);
          }
          function i(e) {
            return (e.j = null), e;
          }
          ...
          (n.fromJSON = function (e, t) {
            ...
            (n.prototype.create = function (e, t, r) {
              for (
                var n, i = new u.Service(e, t, r), o = 0;
                o < this.methodsArray.length;
                ++o
              ) {
                var s = a
                  .lcFirst((n = this.j[o]).resolve().name)
                  .replace(/[^$\w_]/g, '');
                i[s] = a.codegen(
                  ['r', 'c'],
        ...
        function (e, r) {
          ...
          function i(e, r) {
            ...
            function p() {
              ...
              var r = t.exec(e);
              if (!r) throw i('string');
              return (k = t.lastIndex), g(R), (R = null), n(r[1]);
            }
            function h(t) {
              return e.charAt(t);
            }
            function d(t, n) {
              (A = e.charAt(t++)), (T = x), (E = !1);
              var i;
              i = r ? 2 : 3;
              var o,
                s = t - i;
              ...
              for (var a = e.substring(t, n).split(l), c = 0; c < a.length; ++c)
                a[c] = a[c].replace(r ? f : u, '').trim();
              S = a.join('\n').trim();
            }
            function y(t) {
              var r = m(t);
              return /^\s*\/{1,2}/.test(e.substring(t, r));
            }
            function m(e) {
              for (var t = e; t < j && '\n' !== h(t); ) t++;
              return t;
            ...
            function v() {
              ...
              do {
                if (k === j) return null;
                for (t = !1; c.test((s = h(k))); )
                  if (('\n' === s && ++x, ++k === j)) return null;
                if ('/' === h(k)) {
                  if (++k === j) throw i('comment');
                  if ('/' === h(k))
                    if (r) {
                      if (((a = k), (u = !1), y(k))) {
                        u = !0;
              ...
              var f = k;
              if (((o.lastIndex = 0), !o.test(h(f++))))
                for (; f < j && !o.test(h(f)); ) ++f;
              var l = e.substring(k, (k = f));
              return ('"' !== l && "'" !== l) || (R = l), l;
            }
            function g(e) {
              N.push(e);
            ...
            function w(e, t) {
              var r = b();
              if (r === e) return v(), !0;
              if (!t) throw i("token '" + r + "', '" + e + "' expected");
              return !1;
            }
            function O(e) {
              var n = null;
            ...
            return Object.defineProperty(
              { next: v, peek: b, push: g, skip: w, cmnt: O },
              'line',
              {
                get: function () {
                  return x;
      ...
      35: [
        function (e, r) {
          ...
          Object.defineProperties(n.prototype, {
            ...
            ctor: {
              ...
              set: function (e) {
                ...
                for (r = 0; r < this.oneofsArray.length; ++r)
                  n[this.l[r].resolve().name] = {
                    get: d.oneOfGetter(this.l[r].oneof),
                    set: d.oneOfSetter(this.l[r].oneof),
                  };
            ...
            (n.fromJSON = function (e, r) {
              var i = new n(e, r.options);
              (i.extensions = r.extensions), (i.reserved = r.reserved);
              for (var c = Object.keys(r.fields), p = 0; p < c.length; ++p)
                i.add(
                  (t !== r.fields[c[p]].keyType ? f.fromJSON : u.fromJSON)(
                    c[p],
                    r.fields[c[p]]
                  )
                );
              if (r.oneofs)
                for (c = Object.keys(r.oneofs), p = 0; p < c.length; ++p)
                  i.add(a.fromJSON(c[p], r.oneofs[c[p]]));
              if (r.nested)
                for (c = Object.keys(r.nested), p = 0; p < c.length; ++p) {
                  var h = r.nested[c[p]];
                  i.add(
                    (h.id !== t
                      ? u.fromJSON
              ...
              return (
                ...
                r.reserved && r.reserved.length && (i.reserved = r.reserved),
                r.group && (i.group = !0),
                r.comment && (i.comment = r.comment),
                i
              );
            }),
            (n.prototype.toJSON = function (e) {
              ...
              return d.toObject([
                ...
                'extensions',
                this.extensions && this.extensions.length ? this.extensions : t,
                'reserved',
                this.reserved && this.reserved.length ? this.reserved : t,
                'group',
                this.group || t,
            ...
            (n.prototype.add = function (e) {
              if (this.get(e.name))
                throw Error("duplicate name '" + e.name + "' in " + this);
              if (e instanceof u && e.extend === t) {
                if (this.k ? this.k[e.id] : this.fieldsById[e.id])
            ...
            (n.prototype.setup = function () {
              for (
                ...
                t.push(this.b[r].resolve().resolvedType);
              (this.encode = y(this)({ Writer: h, types: t, util: d })),
                (this.decode = m(this)({ Reader: p, types: t, util: d })),
                (this.verify = v(this)({ types: t, util: d })),
        ...
        function (e, r) {
          ...
          (o.codegen = e(3)),
            ...
            (o.toArray = function (e) {
              if (e) {
                for (
                  var t = Object.keys(e), r = Array(t.length), n = 0;
                  n < t.length;
        ...
        function (e, t) {
          ...
          (r.fromNumber = function (e) {
            ...
            (r.prototype.toLong = function (e) {
              return n.Long
                ? new n.Long(0 | this.lo, 0 | this.hi, !!e)
      ...
      39: [
        function (r, n, i) {
          ...
          (a.asPromise = r(1)),
            ...
            (a.Long = (e.dcodeIO && e.dcodeIO.Long) || a.inquire('long')),
      ...
      40: [
        function (e, t) {
          ...
          function n(e, t, n, i) {
            if (t.resolvedType)
              if (t.resolvedType instanceof s) {
                e('switch(%s){', i)('default:')('return%j', r(t, 'enum value'));
                for (
                ...
                e('{')('var e=types[%i].verify(%s);', n, i)('if(e)')(
                  'return%j+e',
                  t.name + '.'
                )('}');
            else
              switch (t.type) {
                ...
                case 'fixed32':
                case 'sfixed32':
                  e('if(!util.isInteger(%s))', i)('return%j', r(t, 'integer'));
                  break;
                case 'int64':
                case 'uint64':
                case 'sint64':
                ...
                case 'float':
                case 'double':
                  e('if(typeof %s!=="number")', i)('return%j', r(t, 'number'));
                  break;
                case 'bool':
                  ...
                  break;
                case 'string':
                  e('if(!util.isString(%s))', i)('return%j', r(t, 'string'));
                  break;
                case 'bytes':
                  e(
          ...
          function o(e) {
            ...
            for (var u = 0; u < e.fieldsArray.length; ++u) {
              ...
              if (
                (f.optional &&
                  t('if(%s!=null&&m.hasOwnProperty(%j)){', l, f.name),
                f.map)
              )
                t('if(!util.isObject(%s))', l)('return%j', r(f, 'object'))(
                  'var k=Object.keys(%s)',
                  l
                ...
                t('if(!Array.isArray(%s))', l)('return%j', r(f, 'array'))(
                  'for(var i=0;i<%s.length;++i){',
                  l
                ),
                  n(t, f, u, l + '[i]')('}');
                ...
                if (f.partOf) {
                  var c = a.safeProp(f.partOf.name);
                  1 === s[f.partOf.name] &&
                    t('if(p%s===1)', c)(
                      'return%j',
      ...
      42: [
        function (e, r) {
          function n(e, r, n) {
            (this.fn = e), (this.len = r), (this.next = t), (this.val = n);
          }
          function i() {}
          function o(e) {
            (this.head = e.head),
          ...
          function f(e, r) {
            (this.len = e), (this.next = t), (this.val = r);
          }
          function l(e, t, r) {
            for (; e.hi; )
              (t[r++] = (127 & e.lo) | 128),
          ...
          (s.create = h.Buffer
            ...
            h.Array !== Array &&
              (s.alloc = h.pool(s.alloc, h.Array.prototype.subarray)),
            (s.prototype.v = function (e, t, r) {
              return (
            ...
            (s.prototype.int32 = function (e) {
              return e < 0 ? this.v(l, 10, d.fromNumber(e)) : this.uint32(e);
            }),
          ...
          (s.prototype.bytes = function (e) {
            var t = e.length >>> 0;
            if (!t) return this.v(a, 1, 0);
            if (h.isString(e)) {
              var r = s.alloc((t = y.length(e)));
              y.decode(e, r, 0), (e = r);
            }
            return this.uint32(t).v(v, t, e);
          }),
            (s.prototype.string = function (e) {
              var t = m.length(e);
              return t ? this.uint32(t).v(m.write, t, e) : this.v(a, 1, 0);
            }),
      ...
      43: [
        function (e, t) {
          ...
          (r.prototype.bytes = function (e) {
            o.isString(e) && (e = o.p(e, 'base64'));
            var t = e.length >>> 0;
            return this.uint32(t), t && this.v(a, t, e), this;
          }),
            (r.prototype.string = function (e) {
              var t = s.byteLength(e);
              return this.uint32(t), t && this.v(n, t, e), this;
            });
        },
        { 39: 39, 42: 42 },
      ],
