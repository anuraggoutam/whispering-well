...
import type ISport from '../../../models/ISport';
    ...
    <div className="sidebar col-md-2">
      ...
      <nav className="collapse casino show">
        <ul>
          ...
          <li className="nav-item">
            <CustomLink to={`/casino-int/live-casino`} className={`nav-link`}>
              <span className="new-launch-text ">Live Casino</span>
            </CustomLink>
          </li>
          <li className="nav-item">
            <CustomLink to={`/casino-int/slots`} className={`nav-link`}>
              <span className="new-launch-text">Slot Game</span>
            </CustomLink>
          </li>
          <li className="nav-item">
            <CustomLink to={`/casino-int/fantasy`} className={`nav-link`}>
