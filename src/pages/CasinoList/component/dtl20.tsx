...
const Dtl20Layout = (props: any) => {
  ...
  const laybacklayout = (from: number, to: number) => {
    ...
    return ['Winner', 'Black', 'Red', 'Odd', 'Even', 'A', '2', '3', '4'].map(
          ...
          <tr key={key} className={`${heightdata}`}>
            ...
            >
              ...
              >
                ...
                {title} {isMobile && ItemNew == 'Winner' ? activeTab : ''}
  ...
  return (
    <div className="container " style={{ marginTop: '-10px' }}>
      <div className="row casino-32A ">
                ...
                <ul className="nav nav-tabs">
                  <li className="nav-item">
                    <a
                      ...
                      href="#dragon"
                      className={
                        activeTab === 'D' ? 'nav-link active' : 'nav-link'
                      }
                    >
                      Dragon
                    </a>
                  ...
                  <li className="nav-item">
                    <a
                      ...
                      href="#tiger"
                      className={
                        activeTab === 'T' ? 'nav-link active' : 'nav-link'
                      }
                    >
                      Tiger
                    </a>
                  ...
                  <li className="nav-item">
                    <a
                      ...
                      href="#Lion"
                      className={
                        activeTab === 'L' ? 'nav-link active' : 'nav-link'
                      }
                    >
                      Lion
                    </a>
        ...
        <div
          className={`col-lg-6 col-6 m-b-10 main-market  ${
            !isMobile ? 'bg-gray' : ''
          }`}
