      ...
      return (
        <div className="table-body" key={keyRunner}>
          ...
          >
            ...
            <div
              className={`${boxLayoutCls2} back2 float-left text-center`}
            ></div>
            <div
              className={`${boxLayoutCls2} back1 back-2 float-left text-center`}
            ></div>
            <div
              className={`${boxLayoutCls2} back float-left back lock text-center betting-disabled`}
              onClick={() => {
            ...
            <div
              className={`${boxLayoutCls2} lay float-left text-center betting-disabled`}
              onClick={() => {
            ...
            <div
              className={`${boxLayoutCls2} lay2 float-left text-center`}
            ></div>
            <div
              className={`${boxLayoutCls2} lay1 float-left text-center`}
            ></div>
          </div>
        </div>
      );
  ...
  return (
    <div>
      <div className="table-header">
        <div
          className={`float-left country-name ${boxLayoutCls} text-info`}
        ></div>
        <div className={`${boxLayoutCls2} float-left`}></div>
        <div className={`${boxLayoutCls2} float-left`}></div>
        <div className={`back ${boxLayoutCls2} float-left text-center`}>
          <b>BACK</b>
        </div>
        <div className={`lay ${boxLayoutCls2} float-left text-center`}>
          <b>LAY</b>
        </div>
        <div className={`${boxLayoutCls2} float-left`}></div>
        <div className={`${boxLayoutCls2} float-left`}></div>
