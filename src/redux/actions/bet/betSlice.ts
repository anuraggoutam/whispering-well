...
const betSlice = createSlice({
  ...
  reducers: {
    ...
    setBookMarketList: (
      ...
      state.userBookMarketList = {
        /*...state.userBookMarketList,*/ ...action.payload,
      };
    },
...
export const selectMarketBook = (state: RootState) =>
  state.betReducer.userBookMarketList;

export const selectBookFancy = (state: RootState) =>
  state.betReducer.fancyMatchAndSelectionId;
export const selectBookMarketUser = (state: RootState) =>
  state.betReducer.marketBookAndSelectionId;
